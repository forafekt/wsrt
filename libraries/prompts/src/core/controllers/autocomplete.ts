...
export interface AutocompleteOptions<T extends OptionLike>
  extends PromptOptions<T['value'] | T['value'][], AutocompleteController<T>> {
  options: T[] | ((this: AutocompleteController<T>) => T[])
  filter?: FilterFunction<T>
  multiple?: boolean
}

export default class AutocompleteController<T extends OptionLike> extends Prompt<
  T['value'] | T['value'][]
> {
  filteredOptions: T[]
  multiple: boolean
