...
export class ConsoleLogger {
	...
	constructor(options: ConsoleLoggerOptions = {}) {
		...
		this.transports = options.transports ?? [new ConsoleTransport(this.pretty)];
	}
	...
	getLevelName(): ConsoleLogLevelName {
		return (Object.entries(CONSOLE_LOG_LEVELS).find(([_, v]) => v === this.level)?.[0] ??
			"info") as ConsoleLogLevelName;
	}
}
